...
if 0 <= challenge_rating <= 4:
    ...
    if 31 <= rando_hundred <= 60:
        print("You gained {:,} silver pieces.".format(dice_roller.d6(4)))
    if 61 <= rando_hundred <= 70:
        print("You gained: {:,} electrum pieces.".format(dice_roller.d6(3)))
    if 71 <= rando_hundred <= 95:
        print("You gained: {:,} gold pieces.".format(dice_roller.d6(3)))
    if 96 <= rando_hundred <= 100:
        print("You gained: {:,} platinum pieces.".format(dice_roller.d6()))
...
if 5 <= challenge_rating <= 10:
    ...
    if 31 <= rando_hundred <= 60:
        print("You gained: {:,} silver pieces and {:,} gold pieces.".format(dice_roller.d6(6) * 10,dice_roller.d6(2) * 10))
    if 61 <= rando_hundred <= 70:
        print("You gained: {:,} electrum pieces and {:,} gold pieces".format(dice_roller.d6(3) * 10,dice_roller.d6(2) * 10))
    if 71 <= rando_hundred <= 95:
        print("You gained: {:,} gold pieces.".format(dice_roller.d6(4)*10))
    if 96 <= rando_hundred <= 100:
        print("You gained: {:,} gold pieces and {:,} platinum pieces".format(dice_roller.d6(2) * 10, dice_roller.d6(3)))
...
if 11 <= challenge_rating <= 16:
    ...
    if 21 <= rando_hundred <= 35:
        print("You gained {:,} electrum pieces and {:,} gold pieces".format(dice_roller.d6()*100,dice_roller.d6()*100))
    if 36 <= rando_hundred <= 75:
        print("You gained {:,} gold pieces and {:,} platinum pieces".format(dice_roller.d6(2)*100,dice_roller.d6()*10))
    if 76 <= rando_hundred <= 100:
        print("You gained {:,} gold pieces and {:,} platinum pieces.".format(dice_roller.d6(2)*100,dice_roller.d6(2)*10))
...
if 17 <= challenge_rating <= 20:
    ...
    if 16 <= rando_hundred <= 55:
        print("You gained {:,} gold pieces and {:,} platinum pieces.".format(dice_roller.d6()*1000,dice_roller.d6()*100))
    if 56 <= rando_hundred <= 100:
        print("You gained {:,} gold pieces and {:,} platinum pieces.".format(dice_roller.d6()*1000,dice_roller.d6(2)*100))
